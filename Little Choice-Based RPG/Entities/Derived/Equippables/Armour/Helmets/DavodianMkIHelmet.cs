...
namespace Little_Choice_Based_RPG.Entities.Derived.Equippables.Armour.Helmets
{
    internal class DavodianMkIHelmet : Helmet
    {
        ...
        public DavodianMkIHelmet()
        {
            base.name = "Davodian MkI Covered Faceplate";
            descriptor.generic = "Discarded aside here is your original Davodian MkI, its dented gunmetal grey faceplate long lustreless";
            descriptor.inspect = "Disfigured and mottled from years of abuse, the gunmetal grey protective sensors relay a live feed, protecting your vision and perceptible hearing.\r\nThe units bodywork has been long since reworked in patchwork copper shielding - under the seams near-charred components made up of scrapped debris poke through residual sand.";
