    ...
    public class InteractionUsingGameObject : Interaction
    {
        ...
        public override void AttemptInvoke(IUserInterface setInvocationMutexIdentity)
        {
            if (invocationMutexIdentity != setInvocationMutexIdentity)
                return; //The sender identity setInvocationMutexIdentity did not match the current invocationMutexIdentity holder! Invocation is already in-use.");
        ...
        protected override void Invoke(IUserInterface setInvocationMutexIdentity)
        {
            ...
            // invoke
            storedDelegate(setInvocationMutexIdentity, invocationParameter1);
