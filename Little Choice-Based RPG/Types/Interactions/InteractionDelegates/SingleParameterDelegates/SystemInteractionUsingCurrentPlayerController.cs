...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.SingleParameterDelegates
{
    ...
    internal class SystemInteractionUsingCurrentPlayerController : Interaction
    {
        ...
        public SystemInteractionUsingCurrentPlayerController(SystemInteractionUsingCurrentPlayerControllerDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, InteractionRole setInteractRole = InteractionRole.Explore)
