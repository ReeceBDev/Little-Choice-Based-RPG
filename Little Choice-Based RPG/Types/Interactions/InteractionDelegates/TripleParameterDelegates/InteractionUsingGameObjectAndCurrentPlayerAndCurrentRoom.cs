...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.TripleParameterDelegates
{
    ...
    public class InteractionUsingGameObjectAndCurrentPlayerAndCurrentRoom : Interaction
    {
        ...
        public InteractionUsingGameObjectAndCurrentPlayerAndCurrentRoom(InteractionUsingGameObjectAndCurrentPlayerAndCurrentRoomDelegate setDelegate, PropertyContainer setSourceContainer, string setInteractTitle, string setInteractDescriptor, GameObject preassignedParameter1, InteractionRole setInteractRole = InteractionRole.Explore)
            : base(setDelegate, setSourceContainer, setInteractTitle, setInteractDescriptor, setInteractRole)
        {
            storedDelegate = setDelegate;
        ...
        public delegate void InteractionUsingGameObjectAndCurrentPlayerAndCurrentRoomDelegate(PlayerController invocationMutexIdentity, PropertyContainer sourceContainer, GameObject gameObject, Player currentPlayer, Room currentRoom);
