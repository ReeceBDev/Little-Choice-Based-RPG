...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.TripleParameterDelegates
{
    ...
    internal class InteractionUsingTwoGameObjectsAndCurrentPlayer : Interaction
    {
        ...
        public InteractionUsingTwoGameObjectsAndCurrentPlayer(InteractionUsingTwoGameObjectsAndCurrentPlayerDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, string firstRequestDescription, string secondRequestDescription, List<EntityProperty>? setFirstGameObjectFilter = null, List<EntityProperty>? setSecondGameObjectFilter = null, InteractionRole setInteractRole = InteractionRole.Explore)
        ...
        public InteractionUsingTwoGameObjectsAndCurrentPlayer(InteractionUsingTwoGameObjectsAndCurrentPlayerDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, GameObject preassignedParameter1, string requestDescription, List<EntityProperty>? gameObjectRequestFilter = null, InteractionRole setInteractRole = InteractionRole.Explore)
            : base(setDelegate, setInteractTitle, setInteractDescriptor, setAssociatedObjectID, setInteractRole)
        {
            storedDelegate = setDelegate;
        ...
        public InteractionUsingTwoGameObjectsAndCurrentPlayer(InteractionUsingTwoGameObjectsAndCurrentPlayerDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, string requestDescription, GameObject preassignedParameter2, List<EntityProperty>? gameObjectRequestFilter = null, InteractionRole setInteractRole = InteractionRole.Explore)
            : base(setDelegate, setInteractTitle, setInteractDescriptor, setAssociatedObjectID, setInteractRole)
        {
            storedDelegate = setDelegate;
        ...
        public delegate void InteractionUsingTwoGameObjectsAndCurrentPlayerDelegate(PlayerController invocationMutexIdentity, GameObject firstTarget_GameObject, GameObject secondTarget_GameObject, Player currentPlayer);
