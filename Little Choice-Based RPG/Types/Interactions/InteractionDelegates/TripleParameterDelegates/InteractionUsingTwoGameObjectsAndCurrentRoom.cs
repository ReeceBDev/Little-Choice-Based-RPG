...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.TripleParameterDelegates
{
    ...
    internal class InteractionUsingTwoGameObjectsAndCurrentRoom : Interaction
    {
        ...
        public delegate void InteractUsingTwoGameObjectsAndCurrentRoomDelegate(PlayerController invocationMutexIdentity, GameObject firstTarget_GameObject, GameObject secondTarget_GameObject, Room first_Room);
