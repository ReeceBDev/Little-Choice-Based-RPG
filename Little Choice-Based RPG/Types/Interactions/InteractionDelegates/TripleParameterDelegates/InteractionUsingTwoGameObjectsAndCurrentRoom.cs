...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.TripleParameterDelegates
{
    ...
    public class InteractionUsingTwoGameObjectsAndCurrentRoom : Interaction
    {
        /// <summary> Delegate to be invoked later with Invoke(). </summary>
        public InteractUsingTwoGameObjectsAndCurrentRoomDelegate storedDelegate;
        ...
        static InteractionUsingTwoGameObjectsAndCurrentRoom()
        {
        ...
        /// <summary> Create a delegate which, unless pre-assigned, will ask the player for two target GameObjects within their location. CurrentRoom is provided upon execution. </summary>
        public delegate void InteractUsingTwoGameObjectsAndCurrentRoomDelegate(PlayerController invocationMutexIdentity, PropertyContainer sourceContainer, GameObject firstTarget_GameObject, GameObject secondTarget_GameObject, Room first_Room);
