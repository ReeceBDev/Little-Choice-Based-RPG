...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.DoubleParameterDelegates
{
    ...
    internal class InteractionUsingTwoGameObjects : Interaction
    {
        ...
        public delegate void InteractUsingTwoGameObjectsDelegate(PlayerController invocationMutexIdentity, GameObject firstTarget_GameObject, GameObject secondTarget_GameObject);
