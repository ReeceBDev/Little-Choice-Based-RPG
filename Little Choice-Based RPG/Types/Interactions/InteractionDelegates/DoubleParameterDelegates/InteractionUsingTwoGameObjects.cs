...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.DoubleParameterDelegates
{
    ...
    public class InteractionUsingTwoGameObjects : Interaction
    {
        ...
        public delegate void InteractUsingTwoGameObjectsDelegate(PlayerController invocationMutexIdentity, PropertyContainer sourceContainer, GameObject firstTarget_GameObject, GameObject secondTarget_GameObject);
