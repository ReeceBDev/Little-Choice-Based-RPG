...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.DoubleParameterDelegates
{
    ...
    internal class SystemInteractionUsingCurrentPlayerControllerAndGameObject : Interaction
    {
        ...
        public SystemInteractionUsingCurrentPlayerControllerAndGameObject(SystemInteractionUsingCurrentPlayerControllerAndGameObjectDelegate setDelegate, string setInteractTitle, string setInteractDescriptor, GameObject preassignedParameter1, InteractionRole setInteractRole = InteractionRole.Explore)
            : base(setDelegate, setInteractTitle, setInteractDescriptor, setInteractRole)
        {
            storedDelegate = setDelegate;
