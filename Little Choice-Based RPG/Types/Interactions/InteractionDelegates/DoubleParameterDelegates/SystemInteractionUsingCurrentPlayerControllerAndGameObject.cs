...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.DoubleParameterDelegates
{
    ...
    internal class SystemInteractionUsingCurrentPlayerControllerAndGameObject : Interaction
    {
        /// <summary> Delegate to be invoked later with Invoke(). </summary>
        public SystemInteractionUsingCurrentPlayerControllerAndGameObjectDelegate storedDelegate;
        ...
        private PlayerController? invocationParameter2 = null;

        private InteractionUsingNothing abortInteraction;

        static SystemInteractionUsingCurrentPlayerControllerAndGameObject()
        {
        ...
        public SystemInteractionUsingCurrentPlayerControllerAndGameObject(SystemInteractionUsingCurrentPlayerControllerAndGameObjectDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, string setGameObjectRequestDescription, List<EntityProperty>? setGameObjectFilter = null, InteractionRole setInteractRole = InteractionRole.Explore)
        ...
        public SystemInteractionUsingCurrentPlayerControllerAndGameObject(SystemInteractionUsingCurrentPlayerControllerAndGameObjectDelegate setDelegate, uint? setAssociatedObjectID, string setInteractTitle, string setInteractDescriptor, GameObject preassignedParameter1, InteractionRole setInteractRole = InteractionRole.Explore)
            : base(setDelegate, setInteractTitle, setInteractDescriptor, setAssociatedObjectID, setInteractRole)
        {
            storedDelegate = setDelegate;
        ...
        public override void AttemptInvoke(PlayerController sourceInvocationMutexIdentity)
        {
            ...
            //Set invocationParameter2 as the current PlayerController.
            invocationParameter2 = sourceInvocationMutexIdentity;
        ...
        protected override void Invoke(PlayerController sourceInvocationMutexIdentity)
        {
            ...
            // invoke
            storedDelegate(invocationParameter1, invocationParameter2);
        ...
        public delegate void SystemInteractionUsingCurrentPlayerControllerAndGameObjectDelegate(GameObject gameObject, PlayerController currentPlayerController);
