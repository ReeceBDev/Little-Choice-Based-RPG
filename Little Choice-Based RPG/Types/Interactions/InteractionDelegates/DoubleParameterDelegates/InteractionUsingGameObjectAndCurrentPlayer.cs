...
namespace Little_Choice_Based_RPG.Types.Interactions.InteractionDelegates.DoubleParameterDelegates
{
    ...
    internal class InteractionUsingGameObjectAndCurrentPlayer : Interaction
    {
        ...
        public delegate void InteractionUsingGameObjectAndCurrentPlayerDelegate(PlayerController invocationMutexIdentity, GameObject gameObject, Player currentPlayer);
