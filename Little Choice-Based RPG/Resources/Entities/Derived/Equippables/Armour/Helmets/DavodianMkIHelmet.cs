...
using Little_Choice_Based_RPG.Resources.Entities.Derived.Equippables.Armour;
using System;
...
namespace Little_Choice_Based_RPG.Resources.Entities.Derived.Equippables.Armour.Helmets
{
    internal class DavodianMkIHelmet : Helmet
    {
        ...
        public DavodianMkIHelmet(Vector2 setPosition) : base(setPosition)
        {
            ...
            equippableDescriptor.equip.Value = "Dusty residue coats your hands as you heave the thick, heavy metal above you and press your forehead in.\r\nInterlocking clicks engage behind your neck, a gentle buzz as the metal comes online.";
            equippableDescriptor.unequip.Value = "Engaging the clasp at the rear, the locks reluctantly scrape their disengaging clicks and the full weight of the visor bears down on your head.\r\nSandpaper lining scratches the sides of your face when you tilt your head forwards and force the faceplate off.";
        }
