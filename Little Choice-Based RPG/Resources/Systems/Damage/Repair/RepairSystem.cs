...
namespace Little_Choice_Based_RPG.Resources.Systems.Damage.Repair
{
    public class RepairSystem : PropertyLogic
    {
        ...
        private void InitialiseRepairChoices(PropertyContainer sourceContainer, PropertyHandler sourceProperties)
        {
        ...
        public InteractionUsingNothing InitialiseRepairUsingNothing(PropertyContainer sourceContainer, PropertyHandler sourceProperties)
        {
        ...
        public InteractionUsingGameObject InitialiseRepairUsingTool(PropertyContainer sourceContainer, PropertyHandler sourceProperties)
        {
        ...
        public void InvokeRepair(IUserInterface mutexHolder, PropertyContainer sourceContainer) => InvokeRepair(mutexHolder, sourceContainer, null);

        /// <summary> Sets Damage.Broken to false, from the BreakSystem. </summary>
        public void InvokeRepair(IUserInterface mutexHolder, PropertyContainer sourceContainer, GameObject? repairTool = null)
        {
        ...
        private void Repair(PropertyContainer sourceContainer)
        {
            //Main repairing logic
            sourceContainer.Properties.UpsertProperty("Damage.Broken", false); //Property found in DamageCommon
